...
void Menu(void)
{
    ...
    char *choice6 = "6.Exit";
    char *copyright = "CopyRight@JIANG YAONAN <HDU>";
...
void every_line(char * left, char * middle, char * right)//����ÿ�е�left��middle��right�ֱ����
{
